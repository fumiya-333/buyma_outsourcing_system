...
@section('content')
	...
	<div class="container py-4">
		<div class="contents">
			<div class="bg-secondary text-white p-3">パスワードリセット</div>
			<div class="shadow-sm px-3 py-4 mb-5 bg-white rounded">
				<form method="post" action="preUpdate">
					{{ csrf_field() }}
					...
					<div class="mt-5">
						<input type="submit" value="パスワードリセット" name="preUpdate" id="preUpdate" class="btn btn-primary btn-lg btn-block">
					</div>
				</form>
			</div>
		</div>
